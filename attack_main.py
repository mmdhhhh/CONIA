...
parser.add_argument('--train_surr', action='store_true', help='Whether to train surrogate model')
parser.add_argument('--train_vict', action='store_true', help='Whether to train victim model')
